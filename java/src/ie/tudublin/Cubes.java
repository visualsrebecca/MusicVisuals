...
public void setup()
{
  ...
  //Charger la chanson
  song = minim.loadFile("FirstClass.mp3");
...
public void settings(){
    ...
    size(1024, 500, "processing.opengl.PGraphics3D");
}
...
public class Cube {
  ...
  void display(float scoreLow, float scoreMid, float scoreHi, float intensity, float scoreGlobal) {
    ...
    int displayColor = color((float)(scoreLow*0.67), (float)(scoreMid*0.67), (float)(scoreHi*0.67), intensity*5);
...
class Mur {
  ...
  void display(float scoreLow, float scoreMid, float scoreHi, float intensity, float scoreGlobal) {
    ...
    int displayColor = color((float)(scoreLow*0.67), (float)(scoreMid*0.67), (float)(scoreHi*0.67), scoreGlobal);
    ...
    displayColor = color((float)(scoreLow*0.5), (float)(scoreMid*0.5), (float)(scoreHi*0.5), scoreGlobal);
